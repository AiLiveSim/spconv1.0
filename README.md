...
Windows PowerShell:
Download cuda [here](https://developer.nvidia.com/cuda-12-4-0-download-archive), boost [here](https://www.boost.org/users/download/) and pytorch [here](https://pytorch.org/get-started/locally/). At the moment of the pytorch version is 2.4.1 you might need to look in the archive. Please check in [windows_TC.cmake](windows_TC.cmake) the paths to the libraries.
